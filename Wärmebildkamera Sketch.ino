...
void setup() {
    ...
    drawColorScale();  // Diese Funktion war vorher nicht deklariert – sie ist jetzt dabei!
}
...
// Akku-Spannungsmessung mit Mittelwertbildung (stabilisiert Anzeige)
float getSmoothedBatteryVoltage() {
    static float voltageSamples[10] = {0}; // Letzte 10 Messwerte
    static int index = 0;
    ...
    return sum / 10.0;  // Durchschnitt berechnen
}
